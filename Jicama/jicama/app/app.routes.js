...
{"ncyBreadcrumb": {"label": "Error"}, "templateUrl": "static/partials/webpage_core/404.html", "url": "/404.html"})
 ...
 //---------------------- 
.state('design_guide', 
{"controller": "designguideController", "data": {"requireLogin": false}, "meta_desc": "A step-by-step guide to designing your study.", "ncyBreadcrumb": {"label": "Design Guide"}, "templateUrl": "static/partials/webpage_design/design.guide.html", "url": "/design_guide"})
...
{"data": {"requireLogin": false}, "meta_desc": "Calculate your sample size with this easy-to-use interface.", "ncyBreadcrumb": {"label": "Sample Size", "parent": "tools.home"}, "templateUrl": "static/partials/webpage_tools/tools.skel.html", "url": "/sample_size"})

 //---------------------- 
.state('tools.powersize', 
{"data": {"requireLogin": false}, "meta_desc": "Calculate your statistical power based on a given sample size.", "ncyBreadcrumb": {"label": "Statistical Power", "parent": "tools.home"}, "templateUrl": "static/partials/webpage_tools/tools.skel.html", "url": "/power_size"})

 //---------------------- 
.state('tools.pwrgraph', 
{"data": {"requireLogin": false}, "meta_desc": "Explore the tradeoff between power and sample size.", "ncyBreadcrumb": {"label": "Power Plots", "parent": "tools.home"}, "templateUrl": "static/partials/webpage_tools/tools.skel.html", "url": "/power_graph"})
...
{"data": {"requireLogin": false}, "meta_desc": "Data analysis", "ncyBreadcrumb": {"label": "Data analysis", "parent": "tools.home"}, "templateUrl": "static/partials/webpage_tools/tools.skel.html", "url": "/analysis"})

 //---------------------- 
.state('tools.sims', 
{"data": {"requireLogin": false}, "meta_desc": "Simulate outcomes of your study.", "ncyBreadcrumb": {"label": "Simulations", "parent": "tools.home"}, "templateUrl": "static/partials/webpage_tools/tools.skel.html", "url": "/simulations"})

 //---------------------- 
.state('tools.report', 
{"controller": "reportsController", "data": {"requireLogin": false}, "meta_desc": "Generate a report of our power and sample size calculations to submit for your proposal", "ncyBreadcrumb": {"label": "Summary Report", "parent": "tools.home"}, "templateUrl": "static/partials/webpage_reports/report.tools.html", "url": "/report"})
...
{"ncyBreadcrumb": {"label": "Checklist", "parent": "report.home"}, "templateUrl": "static/partials/webpage_reports/report.checklist.html", "url": "/checklist"})
 ...
 //---------------------- 
.state('report.user', 
{"data": {"requireLogin": false}, "ncyBreadcrumb": {"label": "User Projects", "parent": "report.home"}, "templateUrl": "static/partials/webpage_reports/report.user_projects.html", "url": "/userprojects"})

 //---------------------- 
.state('report.power', 
{"data": {"requireLogin": false}, "ncyBreadcrumb": {"label": "Sample Size and Power", "parent": "report.home"}, "templateUrl": "static/partials/webpage_reports/report.tools.html", "url": "/power"})
