...
# PASS_AUTH should be set to False (set to True for testing/using without authentication on localhost. Setting True is also what the previous version works like)
PASS_AUTH = True
