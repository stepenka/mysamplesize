nv.models.multiChart = function() {
    ...
    var charts = [lines1, lines2, scatters1, scatters2, bars1, bars2];
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            // KH EDIT: force scatter to be on same domain as rest of graph
            chart.scatters1.xDomain( d3.extent(d3.merge(series1.concat(series2)), function(d) { return d.x }) );
            chart.lines1.xDomain( xDomain || x.domain() );
            ...
            if (wrapLabels) {       // KH addition
                xAxis
                    ._ticks( nv.utils.calcTicksX(availableWidth/10, data) )
                    .tickSize(-availableHeight, 0);
                g.selectAll('.tick text')
                    .call(nv.utils.wrapTicks, chart.xAxis._ticks())
            }
    ...
    chart._options = Object.create({}, {
        ...
        wrapLabels:  {get: function(){return wrapLabels;}, set: function(_){wrapLabels=!!_;}},      // KH addition
        ...
        duration: {get: function(){return duration;}, set: function(_) {
            duration = _;
            [lines1, lines2, scatters1, scatters2, xAxis, yAxis1, yAxis2].forEach(function(model){
