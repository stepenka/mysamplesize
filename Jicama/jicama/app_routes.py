#--------------------------------------------------------------
#   This file is used to generate the files app.routes.js,
#   html5routes.py, sitemap.xml and main.html.
#
#   This version of app_routes.py bypasses login requirements
#   with [# removing login requirement]
#--------------------------------------------------------------
...
# requireLocalLogin = True; # removing login requirement
requireLocalLogin = False;
    ...
    if stateData:
        if single_state_dict["data"]["requireLogin"]:
            ...
            if not isAbstract:
                ...
                templateNoAuth = re.sub('.html', '.html', templateUrl)
