        ...
        selection.each(function(data) {
            ...
            groups
                .attr('class', function(d,i) {
                    // this STR variable is a KH edit to add the class "nv-single-point" when the data contains only a single point.
                    // the styling for this single point can be modified in the nv.d3.scss
                    var str = '';
                    if( d.values.length == 1 )
                        str = 'nv-single-point';
                    
                    return (d.classed || '') + ' nv-group nv-series-' + i + ' ' + str;
                })
